# Article-specific APA 7 rules

- **Title page**: title, authors (each with affiliation), author note, acknowledgments
...
- **Author note**: ORCID, changes of affiliation, disclosures
